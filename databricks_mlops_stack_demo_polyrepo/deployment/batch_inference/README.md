# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [databricks_mlops_stack_demo_polyrepo/resources/README.md](../../resources/README.md)
