...
# ``databricks_mlops_stack_demo_polyrepo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-databricks_mlops_stack_demo_polyrepo-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.databricks_mlops_stack_demo_polyrepo.databricks_mlops_stack_demo_polyrepo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.databricks_mlops_stack_demo_polyrepo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.databricks_mlops_stack_demo_polyrepo.trip_dropoff_features",
