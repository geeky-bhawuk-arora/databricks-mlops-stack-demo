...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``databricks_mlops_stack_demo_polyrepo/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in databricks_mlops_stack_demo_polyrepo/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in databricks_mlops_stack_demo_polyrepo/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-databricks_mlops_stack_demo_polyrepo-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.databricks_mlops_stack_demo_polyrepo.databricks_mlops_stack_demo_polyrepo-model", "Full (Three-Level) Model Name")
