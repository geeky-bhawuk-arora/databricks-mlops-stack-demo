...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks_mlops_stack_demo_polyrepo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-7405611469134624.4.azuredatabricks.net/explore/data/models/staging/databricks_mlops_stack_demo_polyrepo/databricks_mlops_stack_demo_polyrepo-model)
* [Prod model in UC](https://adb-7405611469134624.4.azuredatabricks.net/explore/data/models/prod/databricks_mlops_stack_demo_polyrepo/databricks_mlops_stack_demo_polyrepo-model)
. 
