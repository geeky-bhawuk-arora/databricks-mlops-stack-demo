...
git add README.md docs .gitignore databricks_mlops_stack_demo_polyrepo/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-7405611469134624.4.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-7405611469134624.4.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[databricks_mlops_stack_demo_polyrepo/databricks.yml](../databricks_mlops_stack_demo_polyrepo/databricks.yml) file.
...
Follow the instructions in [databricks_mlops_stack_demo_polyrepo/resources/README.md](../databricks_mlops_stack_demo_polyrepo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../databricks_mlops_stack_demo_polyrepo/resources/README.md)  to propose, test, and deploy
