...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_proj_a-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-7405606957834914.14.azuredatabricks.net/explore/data/models/staging/mlops_proj_a/mlops_proj_a-model)
* [Prod model in UC](https://adb-7405606957834914.14.azuredatabricks.net/explore/data/models/prod/mlops_proj_a/mlops_proj_a-model)
. 
