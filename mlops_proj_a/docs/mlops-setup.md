...
git add README.md docs .gitignore mlops_proj_a/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-7405606957834914.14.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-7405606957834914.14.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[mlops_proj_a/databricks.yml](../mlops_proj_a/databricks.yml) file.
...
Follow the instructions in [mlops_proj_a/resources/README.md](../mlops_proj_a/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_proj_a/resources/README.md)  to propose, test, and deploy
